...
Framework base para **pruebas funcionales automatizadas** con ejecución **multinavegador**, soporte para ejecución **local y remota**, y generación automática de **reportes HTML** con dashboard.

Este proyecto sirve como *template* inicial para construir una arquitectura limpia y escalable de automatización con **Selenium WebDriver + JUnit 5 + Maven**, soportando ejecución en:
...
**Selenium Cross Browser** es un template moderno y robusto que permite ejecutar pruebas funcionales en múltiples navegadores, con reportes profesionales y compatibilidad total con pipelines CI/CD.
